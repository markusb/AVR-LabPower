 ...
 *
 * Adapted for winavr: Markus Baertschi, markus@markus.org
 *
 **********************************************************************
 *
...
/*
 * Usage instructions:
 * 		- define a state variable per rotary encoder:
 *  	unsigned char rot1;
 *  	- set the port values (bits 5&6 of portb)
 *  	DDRB = 0b01100000;
 *		PORTB = 0b01100000;
 *  	- poll the rotary encoder using the state table
 *     	rot1 = ttable[rot1 & 0xf][(PINB>>5)];
 */
